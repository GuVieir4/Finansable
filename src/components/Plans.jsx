                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <div className="border border-black/10 dark:border-white/10 rounded-xl p-8 flex flex-col bg-white/50 dark:bg-[#2E7D32]">
                            ...
                            <a
                                className="mt-8 w-full text-center bg-black/5 dark:bg-[#264533] text-black dark:text-white font-semibold py-3 rounded-lg hover:bg-black/10 dark:hover:bg-white/20 transition-colors"
                                href="#"
                            >
                                Começar Grátis
                            </a>
                        ...
                        <div className="relative border border-[#38e07b] rounded-xl p-8 flex flex-col bg-[#264533]">
                            ...
                            <a
                                className="mt-8 w-full text-center bg-[#38e07b] text-white font-semibold py-3 rounded-lg hover:bg-[#38e07b]/90 transition-colors"
                                href="#"
                            >
